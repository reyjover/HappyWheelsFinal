  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.php"><h2>Happy <em>Wheels</em></h2></a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li> <a class="nav-link" href="index.php?loadnav=howtouse"> How to use </a> </li>

              <li> <a class="nav-link" a href="index.php?logout='1'">logout</a> </li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <p><b>Members: &nbsp; BSIT_2A </b></br>
              Carl Jerome Aguilar </br>
              Sanny Rey Jover </br>
              Francisco Jubelag XV </br></br></p> 
